...
export default function TemplatesProjectsPage() {
  ...
  const routeMeta = getAdminRouteById('templates-projects');
  useEffect(() => {
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold">Templates & Projects</h1>
              <p className="text-muted-foreground mt-2">
                Configure templates and collaborative projects settings.
              </p>
            </div>
            <Button
