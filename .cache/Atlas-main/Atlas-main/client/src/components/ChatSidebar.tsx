    ...
    return (
      ...
      >
        <div className="space-y-3">
          ...
          <div
            className="hover-elevate flex cursor-pointer items-center gap-2 md:gap-3 rounded-2xl p-1.5 md:p-2 transition-all"
    ...
    >
      <div className="flex h-full w-full flex-col">
        <div className="hidden border-b border-sidebar-border md:block md:p-6">
          <Button
            onClick={() => onNewChat(null)}
            className="h-11 w-full justify-start gap-3 shadow-sm"
            variant="default"
